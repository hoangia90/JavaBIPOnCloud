...
//	//Reset all counter if all servers reached
//	public void resetAllSeverCounters () throws IOException {
//		
//		boolean isAllServerLimitReached = true;
//		
//		for(String item : Switch.serverslist){
//			String content = requestLimitInfo(item);
//			JSONObject jsonObj = new JSONObject(content);
//			int counter = jsonObj.getInt("counter");
//		    int limit = jsonObj.getInt("requestLimit");
//			if (counter != limit ) {
//				isAllServerLimitReached = false;
//			}
//		}
//		
//		if (isAllServerLimitReached) {
//			//reset 
//		}
//
//	}
